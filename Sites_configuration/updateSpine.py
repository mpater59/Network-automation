...
def get_neighbor_ports(selected_device, site):
    ...
    for neighbor in neighbors:
        if neighbor["device information"]["type"] == "leaf":
            ...
            neigh_ip_addr = f'{site_id}.{device_config_id}.{200 + neighbor["device information"]["id"]}.1/30'
...
def update_spine(selected_device, devices_file, selected_site, db_config=None, active=False, expand=False):
            ...
            if key_exists(db_config, "bgp", "neighbors"):
                for neigh_id in db_config["bgp"]["neighbors"]:
                    if neigh_id == bgp_id_neigh:
                        ...
                        db_config["bgp"]["neighbors"][neigh_id]["evpn rrc"] = True
                        db_config["bgp"]["neighbors"][neigh_id]["rrc"] = True
                        break
