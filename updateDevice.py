...
def update_devices(site, devices, status=None, soft_update=True, expand=True):
    ...
    for selected_device in selected_devices:
        update_device(site, selected_device, soft_update, expand)
...
parser.add_argument("-df", "--devices", dest="devices",
...
update_devices(args.site, args.devices, args.status_text, args.soft_update, args.expand)
